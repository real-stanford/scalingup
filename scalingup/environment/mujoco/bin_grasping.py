...
class TableTopBinGraspingFR5MujocoEnv(TableTopFR5MujocoEnv):
    def __init__(
        self,
        asset_paths: List[str],
        bin_x_offset: float,
...
class TableTopBinGraspingRobotiq85MujocoEnv(TableTopRobotiq85MujocoEnv):
    def __init__(
        self,
        asset_paths: List[str],
        bin_x_offset: float,
...
class TableTopBinGraspingFR5DHPGI80MujocoEnv(TableTopFR5DHPGI80MujocoEnv):
    def __init__(
        self,
        asset_paths: List[str],
        bin_x_offset: float,
