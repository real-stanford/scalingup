...
def sock_inside_washing_machine(init_state: EnvState, final_state: EnvState):
    # the washing machine has a door which can be opened (activated state)
    # or closed (de-activated state). its door needs to be returned to a
    # closed state after the sock is moved inside.
...
def sock_inside_washing_machine_with_washing_machine_opened(
    ...
    # the washing machine has a door which can be opened (activated state)
    # or closed (de-activated state). however, since it starts off in an
    # open state, the door does not need to be closed after sock is moved
    # inside.
    sock_inside_washing_machine = check_inside(final_state, "sock", "washing machine")
